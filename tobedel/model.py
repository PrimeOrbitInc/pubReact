...
class CloudResource:
    ...
    def __init__(self, cloud_resource_id=None, cloud_account_id=None,
                 cloud_account_name=None, region=None, organization_id=None,
...
class InstanceResource(CloudResource):
    ...
    def __repr__(self):
        return 'Instance {0} name={1} flavor={2} cloud_acc={3} stopped_allocated={4}'.format(
            self.cloud_resource_id, self.name, self.flavor,
            self.cloud_account_name, self.stopped_allocated)
...
class PodResource(CloudResource):
    ...
    def __init__(self, name=None, created_by_kind=None, created_by_name=None, host_ip=None,
                 instance_address=None, k8s_node=None, k8s_namespace=None, pod_ip=None,
                 k8s_service=None, **kwargs):
        super().__init__(**kwargs)
        self.name = name
...
class RdsInstanceResource(CloudResource):
    ...
    def __repr__(self):
        return 'RDS Instance {0} name={1} flavor={2} cloud_acc={3}'.format(
            self.cloud_resource_id, self.name, self.flavor,
